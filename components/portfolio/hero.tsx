      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8 flex justify-center">
          <img
            src="/logo.svg"
            alt="SN Logo"
            className="h-24 w-24 sm:h-32 sm:w-32 lg:h-40 lg:w-40 animate-pulse"
          />
        </div>
        ...
        <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
          Passionate about building real-world systems through clean code and
          problem-solving. Focused on AI, Machine Learning, and scalable
          software solutions through hands-on academic and personal projects.
        </p>
